                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" class="heading_block block-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                                        <tr>
                                                            <td class="pad" style="text-align:center;width:100%;padding-top:35px;">
                                                                <h6 style="margin: 0; color: #072b52; direction: ltr; font-family: 'Lora', Georgia, serif;font-size:20px; font-weight: normal; letter-spacing: 1px; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><strong>Sales Summary Report</strong></h6>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                            ...
                                                            <td class="pad" style="padding-bottom:20px;padding-left:15px;padding-right:15px;padding-top:40px;">
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div class="" style="font-size: 12px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px; color: #222222; line-height: 1.5;">
                                                                        ...
                                                                        <p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size:16px;">Sales Summary report between <strong>{{$fromDate}}</strong> and <strong>{{$toDate}}<strong> is READY </span><span style="background-color:transparent;">.</span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
