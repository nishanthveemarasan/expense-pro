                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" class="heading_block block-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                                        <tr>
                                                            <td class="pad" style="text-align:center;width:100%;padding-top:35px;">
                                                                <h5 style="margin: 0; color: #072b52; direction: ltr; font-family: 'Lora', Georgia, serif; font-size: 50px; font-weight: normal; letter-spacing: 1px; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><strong>Request</strong></h5>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                            ...
                                                            <td class="pad" style="padding-bottom:40px;padding-left:15px;padding-right:15px;padding-top:40px;">
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div class="" style="font-size: 12px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px; color: #222222; line-height: 1.5;">
                                                                        ...
                                                                        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 24px;"><span style="font-size:16px;">Request received to Activate Account</span><span style="background-color:transparent;">.</span></p>
                                                                        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 18px;"> </p>
                                                                        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 24px;">Company ID : {{$company_id}}</p>
                                                                        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 24px;">USer ID : {{$user_id}}</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
